...
class GCMDeviceQuerySet(models.query.QuerySet):
    def send_message(self, message):
        ...
        return gcm_send_bulk_message(registration_ids=list(self.values_list("registration_id", flat=True)),
                                     data={"msg": message}, collapse_key="message")
...
class GCMDevice(Device):
    ...
    def send_message(self, message):
        ...
        return gcm_send_message(registration_id=self.registration_id, data=message, collapse_key="message")
